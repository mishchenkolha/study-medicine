...
const DOMAIN_URL = ("TURBOPACK compile-time value", "http://localhost:3000");
const STRAPI_URL = ("TURBOPACK compile-time value", "http://localhost:1337");
const MEDIA_LIBRARY_URL = ("TURBOPACK compile-time value", "http://localhost:1337");
...
async function fetchFromStrapi(path, { method = 'GET', body, token, headers = {}, cache = 'force-cache', revalidate = Number(("TURBOPACK compile-time value", "3600") ?? 0), ttl, tags = [] } = {}) {
    ...
    if (isGet && __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$cache$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SIX_MONTHS_SECONDS"] > 0) {
        ...
        try {
            cached = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$cache$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCached"])(key);
        } catch (err) {
...
"[project]/app/certificates/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    let json;
    try {
        const queryString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qs$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stringify"])({
            populate: [
                'certificate'
            ],
            pagination: {
        ...
        json = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$strapi_client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["strapiService"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$routes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ROUTES"].CERTIFICATES}?${queryString}`);
    } catch  {
    ...
    const absoluteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getImageURL"])(fileUrl);
    const fileRes = await fetch(absoluteUrl);
    if (!fileRes.ok || !fileRes.body) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Cannot fetch file'
        }, {
            status: 500
        });
    }
    const contentType = file?.mime || fileRes.headers.get('content-type') || 'application/pdf';
    const fileName = file?.name || 'certificate.pdf';
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](fileRes.body, {
        headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14f1f9d8._.js.map