...
export interface ApiConsultingAndNetworkingConsultingAndNetworking
  extends Struct.SingleTypeSchema {
  collectionName: 'consulting_and_networkings';
  info: {
    displayName: 'consulting and networking';
    pluralName: 'consulting-and-networkings';
    singularName: 'consulting-and-networking';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::consulting-and-networking.consulting-and-networking'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attachments: Schema.Attribute.Component<'llist.files', false>;
...
export interface ApiDictionaryDictionary extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    labels: Schema.Attribute.Component<'components.dictionary-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    benefits: Schema.Attribute.Component<'llist.faqs', false>;
    courses: Schema.Attribute.Component<'llist.cards', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answers: Schema.Attribute.Component<'components.qa', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::quiz.quiz'> &
      Schema.Attribute.Private;
    min_percent_treshold: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
...
export interface ApiResultResult extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certificate_sent: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    course: Schema.Attribute.Relation<'oneToOne', 'api::course.course'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::consulting-and-networking.consulting-and-networking': ApiConsultingAndNetworkingConsultingAndNetworking;
